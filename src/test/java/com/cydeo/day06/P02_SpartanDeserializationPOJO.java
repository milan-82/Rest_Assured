...
public class P02_SpartanDeserializationPOJO extends SpartanTestBase {
    @DisplayName("DET Single Spartan for deserialization to POJO (Spartan class)")
    @Test
    public void test1() {
     ...
     */
        ...
        Spartan spartan = response.as(Spartan.class);//JACKSON library making deserialization from JSON to Spartan,
        //all info saved in spartan Object with as method
    ...
    @DisplayName("GET Spartans from search end point and deserialization to POJO")
    @Test
    public void test2(){
